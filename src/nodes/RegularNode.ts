...
class NodeConfig {
    ...
    constructor() {
        ...
        this.gloss = true;
        this.shadow = true;
        this.titleHighlight = true;
        this.colorSpill = true;
    }
}
...
export default class RegularNode {
    ...
    initShadow() {
        if (this.config.shadow) {
            if (!this.shadow) {
                this.shadow = new PIXI.NineSlicePlane(TexturesHandler.shadowTexture, 21, 21, 21, 21);
            }
    ...
    initGloss() {
        if (this.config.gloss) {
            if (!this.gloss) {
                this.gloss = new PIXI.NineSlicePlane(TexturesHandler.glossTexture, 7, 7, 7, 7);
            }
    ...
    initTitleHighlight() {
        if (this.config.titleHighlight) {
            if (!this.titleHighlight) {
                this.titleHighlight = new PIXI.NineSlicePlane(TexturesHandler.titleHighlightTexture, 7, 7, 7, 7);
            }
    ...
    initColorSpill() {
        if (this.config.colorSpill) {
            if (!this.colorSpill) {
                this.colorSpill = new PIXI.NineSlicePlane(TexturesHandler.colorSpillTexture, 6, 6, 1, 1);
            }
